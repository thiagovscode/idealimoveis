...
import { Imovel, TipoImovel, CategoriaImovel, Caracteristica, TipoMidia } from '../types';
import ImageUpload from '../components/ImageUpload';

const CadastrarImovel: React.FC = () => {
  const navigate = useNavigate();
  const [loading, setLoading] = useState(false);
  const [tempUid] = useState(() => crypto.randomUUID()); // UID temporário para upload
  ...
  return (
    <div className="container" style={{ padding: '2rem 1rem' }}>
      <div style={styles.header}>
        <h1 style={styles.title}>Cadastrar Novo Imóvel</h1>
      ...
      <form onSubmit={handleSubmit} className="card">
        ...
        <div style={styles.field}>
          ...
          <input
            ...
            style={styles.input}
            required
            placeholder="Ex: Casa com Piscina no Centro"
          />
        </div>
